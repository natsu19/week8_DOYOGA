...
jQuery(function () {
  ...
  if (autoPlaySwiper) {
    var _swiper = new Swiper(".autoPlaySwiper", {
      slidesPerView: 2,
      spaceBetween: 30,
      loop: true,
      autoplay: {
  ...
  if (feedbackSwiper) {
    var _swiper2 = new Swiper(".feedbackSwiper", {
      slidesPerView: 1,
      spaceBetween: 30,
      grid: {
        rows: 3,
  ...
  var ClassLevel = document.querySelector('.ClassLevel');

  if (ClassLevel) {
    var _swiper3 = new Swiper(".ClassLevel", {
      slidesPerView: 1,
      spaceBetween: 24,
      grid: {
        fill: 'row',
